...
class _WebServices implements WebServices {
  _WebServices(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://fitness-app-api-580642313220.us-central1.run.app/';
  }
  ...
  @override
  Future<SignUpResponsetModel> createNewUser(
    ...
    final _options = _setStreamType<SignUpResponsetModel>(
    ...
    late SignUpResponsetModel _value;
    try {
      _value = SignUpResponsetModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<LoginResponsetModel> login(LoginRequesttModel loginData) async {
    ...
    final _options = _setStreamType<LoginResponsetModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/Auth/login',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LoginResponsetModel _value;
    try {
      _value = LoginResponsetModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<List<MealsResponseModel>> getMeals(
    String mealType,
    String? token,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<void> addToFavMeal(String id, String? token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'Authorization': token};
  ...
  @override
  Future<void> deleteFavMeal(String id, String? token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'Authorization': token};
  ...
  @override
  Future<void> addToFavExe(String id, String? token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'Authorization': token};
  ...
  @override
  Future<void> deleteFavExe(String id, String? token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{r'Authorization': token};
