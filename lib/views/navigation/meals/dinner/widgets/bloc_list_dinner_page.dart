...
class BlocListDinnerPage extends StatelessWidget {
  final bool showArrowBack;
  final int? index;
  
  const BlocListDinnerPage({
    super.key, 
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<DinnerCubit, DinnerState>(
      builder: (context, state) {
        if (state is MealByTypeDinnerSuccessState) {
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  state.mealByTypeList[inx].name.toString(),
                                ...
                                if (state.mealByTypeList[inx].description != null && 
                                    state.mealByTypeList[inx].description!.isNotEmpty)
                                  Text(
                                    _truncateText(state.mealByTypeList[inx].description!, 40),
                              ...
                              Stack(
                                children: [
                                  Container(
                                    ...
                                    child: Hero(
                                      tag: 'meal_image_${state.mealByTypeList[inx].id}',
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(smallBorderRadius),
                                        child: Image.network(
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        state.mealByTypeList[inx].description ?? 'No description available',
