...
class BlocListStrengthPage extends StatelessWidget {
  final bool showArrowBack;
  final int? index;
  const BlocListStrengthPage(
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<StrengthCubit, StrengthState>(
      builder: (context, state) {
        if (state is ExeByTypeStrengthSuccessState) {
              ...
              return Card(
                ...
                child: ExpansionTile(
                  ...
                  children: [
                    ...
                    ListTile(
                      title: Text(
                        'Protein: ${state.exeByTypeList[inx].description}',
