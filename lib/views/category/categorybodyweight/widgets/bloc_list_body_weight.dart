...
class BlocListBodyWeight extends StatefulWidget {
  final bool showArrowBack;
  const BlocListBodyWeight({super.key, required this.showArrowBack});

  @override
  State<BlocListBodyWeight> createState() => _BlocListBodyWeightState();
}

class _BlocListBodyWeightState extends State<BlocListBodyWeight>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BodyweightCubit, BodyweightState>(
      builder: (context, exeState) {
        if (exeState is ExeByTypeBodyWeightSuccessState) {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            "No body weight exercises available",
            style: TextStyle(
          ...
          Padding(
            ...
            child: Text(
              "Check back later for body weight workout options",
