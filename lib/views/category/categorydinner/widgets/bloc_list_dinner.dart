...
class BlocListDinner extends StatefulWidget {
  final bool showArrowBack;
  final int tabIndex;
  const BlocListDinner({super.key, required this.showArrowBack, required this.tabIndex});

  @override
  State<BlocListDinner> createState() => _BlocListDinnerState();
}

class _BlocListDinnerState extends State<BlocListDinner>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<DinnerCubit, DinnerState>(
      builder: (context, mealState) {
        if (mealState is MealByTypeDinnerSuccessState) {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              "Check back later for delicious dinner options",
