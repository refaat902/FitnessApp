...
class MuscleMassPage extends StatefulWidget {
  const MuscleMassPage({super.key});

  @override
  State<MuscleMassPage> createState() => _MuscleMassPageState();
}

class _MuscleMassPageState extends State<MuscleMassPage> {
                ...
                children: [
                  Expanded(
                      child: ElevatedButton(
                          onPressed: () {
Navigator.push(context, CustomPageRoute(page: const FitnessLevelPage(),transitionType: TransitionType.fade));
                          },
